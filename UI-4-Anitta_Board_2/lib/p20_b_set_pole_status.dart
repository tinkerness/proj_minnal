...
class SetPoleStatus extends StatefulWidget {
  const SetPoleStatus({super.key});

  @override
  State<SetPoleStatus> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<SetPoleStatus> {
